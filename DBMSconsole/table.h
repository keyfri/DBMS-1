...
int modifyCol(QString user,QString DBname,QString TBname,QString oldname,QString newname,QString type,Constraint constraint);//修改一列的名称及类型，只允许添加非空约束条件，true代表添加，false代表不添加
...
void clearFiles(const QString &folderFullPath);//删除文件夹中的所有文件
